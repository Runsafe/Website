...
<h2>Gameplay</h2>
	...
	<p><b>Spleef</b> - This world has recently been merged into a plot within creative world but still functions as it's own world there. Our spleef areans functions completey automatically and allows players to play spleef with ease, you don't even need to be a builder to play!</p>
<h2>Staff</h2>
	<div id="staff-list">
		<div id="staff-left">
			<?php
